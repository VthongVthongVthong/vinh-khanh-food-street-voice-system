...
HeaderSubtitleLabel.Text = _resourceManager.GetString("Home_Featured_Desc");
  ...
  TimeSliderLabel.Text = _resourceManager.GetString("Map_TimeSlider_Label") ?? "Kh�m ph� theo gi?";
  RadiusSliderLabel.Text = _resourceManager.GetString("Map_RadiusSlider_Label") ?? "B�n k�nh qu�t xung quanh";
  
  // ? NEW: Code-behind for Empty State labels
  EmptyStateTitleLabel.Text = _resourceManager.GetString("Map_EmptyState_Title") ?? "Kh�ng c� POI n�o trong b�n k�nh";
  EmptyStateDescLabel.Text = _resourceManager.GetString("Map_EmptyState_Description") ?? "Hi?n t?i kh�ng c� POI n�o trong b�n k�nh";
  ...
  EmptyStateHintLabel.Text = _resourceManager.GetString("Map_EmptyState_Hint") ?? "H�y ki?m tra ??nh v? c?a b?n ho?c t?ng b�n k�nh qu�t ?? t�m nh� h�ng.";
